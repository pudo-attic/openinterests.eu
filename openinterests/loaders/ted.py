...
from monnet.ted.util import ted_contracts

log = logging.getLogger('openinterests.loaders.ted')
...
def load_entity(loader, c, prefix, schemata=[], source_url=None):
    ...
    e.set('country', c.pop(prefix + '_country_common', None))
    e.set('country_code', c.pop(prefix + '_country_code', None))
